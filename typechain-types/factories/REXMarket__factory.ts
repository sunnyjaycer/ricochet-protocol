...
import type { REXMarket, REXMarketInterface } from "../REXMarket";
...
export class REXMarket__factory {
  static readonly abi = _abi;
  static createInterface(): REXMarketInterface {
    return new utils.Interface(_abi) as REXMarketInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): REXMarket {
    return new Contract(address, _abi, signerOrProvider) as REXMarket;
  }
}
