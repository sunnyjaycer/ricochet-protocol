...
export interface REXOneWayMarketInterface extends utils.Interface {
  contractName: "REXOneWayMarket";
  functions: {
    ...
    "initializeOneWayMarket(address,address,uint256,uint256,address,uint128,uint256,uint128)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "initializeOneWayMarket",
    values: [
      string,
      string,
      BigNumberish,
...
export interface REXOneWayMarket extends BaseContract {
  contractName: "REXOneWayMarket";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: REXOneWayMarketInterface;
  ...
  functions: {
    ...
    initializeOneWayMarket(
      ...
      _outputToken: string,
      _feeRate: BigNumberish,
      _ouptutTokenRequestId: BigNumberish,
      _shareScaler: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
