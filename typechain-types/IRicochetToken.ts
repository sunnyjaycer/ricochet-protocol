...
export interface IRicochetTokenInterface extends utils.Interface {
  contractName: "IRicochetToken";
  functions: {
    "burnFrom(address,uint256,bytes)": FunctionFragment;
    "createAgreement(bytes32,bytes32[])": FunctionFragment;
    "downgradeFrom(address,uint256)": FunctionFragment;
    ...
    "mintTo(address,uint256,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "downgradeFrom",
...
export interface IRicochetToken extends BaseContract {
  contractName: "IRicochetToken";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IRicochetTokenInterface;
  ...
  callStatic: {
    ...
    lock(_lockIt: boolean, overrides?: CallOverrides): Promise<void>;
